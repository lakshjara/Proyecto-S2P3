// Este es el programa principal de la Agenda de Contactos. Permite al usuario interactuar con la agenda mediante un menú para agregar, buscar, mostrar, editar y eliminar contactos.
