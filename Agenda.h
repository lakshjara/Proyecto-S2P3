// Este es el programa creado para la clase Agenda. Administra un arreglo de contactos, permitiendo agregarlos, mostrarlos, buscarlos, editarlos y eliminarlos.
